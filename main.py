...
IMAGE_PHATH = "Goose"
PLAYER_IMAGES = os.listdir(IMAGE_PHATH)
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(100, HEIGHT-250), *enemy_size)
...
while playing:
    ...
    for event in pygame.event.get():
        ...
        if event.type == CHANGE_IMAGE:
            player = pygame.image.load(os.path.join(IMAGE_PHATH, PLAYER_IMAGES[image_index]))
            image_index += 1
